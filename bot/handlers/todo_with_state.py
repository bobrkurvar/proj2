...
from bot.states.todo_states import FSMTodoFill
...
@router.message(F.text.startswith('/edit_task'), StateFilter(default_state))
async def process_edit_task(message: Message, state: FSMContext, list_id: list):
